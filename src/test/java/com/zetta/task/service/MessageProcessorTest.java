...
class MessageProcessorTest {
	...
	void setUp() {
		...
		messageProcessor = new MessageProcessor(conditionEngine, transformationEngine, messageStateRepository,
				stateDeltaRepository, messageProducer, objectMapper, resourceLoader);
	}
	...
	void testProcessMessage_UpdatesExistingState() throws Exception {
		...
		verify(messageStateRepository, times(1))
				.save(argThat(state -> state.getMessageId().equals("test-003") && state.getId().equals(1L)));
	}
}
